...
usage(const char* message = 0)
{
    ...
    fprintf(stderr,
	    ...
	    "-mmf f          Mean multiplicative factor\n"
	    "-maf f          Mean additive factor\n"
	    "-smf f          Standard-deviation multiplicative factor\n"
            "-saf f          Standard-deviation additive factor\n"
	    "-lr <range>     label range\n"
            "-iswap          do byteswapping on input\n"
...
static void
pfile_addsil(InFtrLabStream_PFile in_stream,
