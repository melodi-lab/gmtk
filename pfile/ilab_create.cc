...
#include "ILab.h"
#include "intvec.h"	/* for byteorder routines */
...
main(int argc, const char *argv[])
{
    ...
    OutLabStream* out_streamp
        = new OutLabStream_ILab(debug_level,
				   "",
				   out_fp,
				   max_label,
				   1);
