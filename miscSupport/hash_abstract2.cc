...
bool hash_abstract2::global_foundp = false;

const unsigned
hash_abstract2::HashTableDefaultApproxStartingSize = 20000;

float
hash_abstract2::loadFactor = 0.5;
...
const unsigned
hash_abstract2::HashTable_PrimesArray[] = {
3,
5,
11,
23,
...
const unsigned 
hash_abstract2::HashTable_SizePrimesArray
