 ...
 *-----------------------------------------------------------------------
 */
void Sw_ObsDiscRV::printSelf(FILE *f,bool nl)
{
 ...
 *-----------------------------------------------------------------------
 */
void Sw_ObsDiscRV::printSelfVerbose(FILE *f)
{
 ...
 */
bool
Sw_ObsDiscRV::identicalStructureWith(RV& other)
{
 ...
 */
void
Sw_ObsDiscRV::tieParametersWith(RV*const other,
				bool checkStructure)
{
  ...
  if (!SwDiscRV::tieParametersWith( (SwDiscRV*)other,checkStructure))
    error("ERROR: trying to tie parameters of Switching Observed Discrete RV '%s' with RV '%s' but they have different structure.",
	  name().c_str(),other->name().c_str());
  curCPT = ((Sw_ObsDiscRV*)other)->curCPT;
}
 ...
 *-----------------------------------------------------------------------
 */
Sw_ObsDiscRV* Sw_ObsDiscRV::cloneRVShell()
{
  Sw_ObsDiscRV* rv = (Sw_ObsDiscRV*)ObsDiscRV::cloneRVShell();
