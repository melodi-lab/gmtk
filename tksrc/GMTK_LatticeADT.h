...
public:
    ...
    bool generateLargerCPTs(LatticeNode & node, unsigned delta, logpr & acu_posterior);

    void queryLargerCPT(LatticeNode & node, unsigned delta, shash_map_iter<unsigned, LatticeEdgeList> & result, std::set<unsigned>& path_labels, logpr & acu_posterior);
    void addMap2Map(shash_map_iter<unsigned, LatticeEdgeList> & map1, shash_map_iter<unsigned, LatticeEdgeList> & map2, std::set<unsigned>& path_labels, logpr & acu_posterior);

    void dfsOnNode(LatticeNode & cur_node, unsigned delta, shash_map_iter<unsigned, LatticeEdgeList> & result, logpr & acu_posterior);

    void addNodeEdge2Map(shash_map_iter<unsigned, LatticeEdgeList> & added, unsigned child_id, LatticeEdge & edge, logpr & acu_posterior);
