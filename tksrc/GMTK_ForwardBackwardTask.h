...
class ForwardBackwardTask : public virtual SeriesInferenceAlgorithm {

 public:

  ForwardBackwardTask(FileSource &observation_source) : observation_source(observation_source) {}
