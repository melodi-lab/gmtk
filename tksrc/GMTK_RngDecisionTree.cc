  ...
  )
{
  ...
  //////////////////////////////////////////////////////////////////////////
  // Check to make sure we are not seeking past the end of DTs
  //////////////////////////////////////////////////////////////////////////
  if (dt_nmbr >= numDTs) {
    error("ERROR: Trying to seek to DT index %d in file %s which contains only %d DTs", 
	  dt_nmbr, dtFileName.c_str(), numDTs);
  }
