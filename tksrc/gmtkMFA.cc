...
printf("writing IA to %s\n", output_tri_file.c_str());
  ...
  if (jut >= 0) {
	...
	printf("   --- Prologue max clique weight = %f, total weight = %f, jt_weight = %f\n",
	       ...
	       SectionScheduler::junctionTreeWeight(gm_template.P.cliques,
	...
	printf("   --- Chunk max clique weight = %f, total Cx%d weight = %f, per-chunk total C weight = %f, jt_weight = %f\n",
	       ...
	       SectionScheduler::junctionTreeWeight(gm_template.C.cliques,
	...
	printf("   --- Epilogue max clique weight = %f, total weight = %f, jt_weight = %f\n",
	       ...
	       SectionScheduler::junctionTreeWeight(gm_template.E.cliques,
						emptySet,
