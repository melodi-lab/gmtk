...
/*************************************************************************************************************/
  ...
  Arg("cusample",Arg::Opt,MaxClique::cliqueBeamUniformSampleAmount,"Uniformly sample pruned clique (0<v=<=1 fraction, > 1 number)"),
    ...
    Arg("use_k_adap", Arg::Opt, MaxClique::useAdaptiveKPrune, "use k adaptive pruning"),
    Arg("k_downrate", Arg::Opt, MaxClique::kbeam_down_rate, "down rate for adaptive kbeam"),
    Arg("k_uprate", Arg::Opt, MaxClique::kbeam_up_rate, "up rate for adaptive kbeam"),
    Arg("k_window", Arg::Opt, MaxClique::kbeam_window, "window size for adaptive kbeam"),
    Arg("k_upthresh", Arg::Opt, MaxClique::up_threshold, "up threshold for adaptive kbeam"),
    Arg("k_downthresh", Arg::Opt, MaxClique::down_threshold, "up threshold for adaptive kbeam"),
    Arg("k_adap_init", Arg::Opt, MaxClique::initial_k, "init k beam for adaptive kbeam"),
    Arg("k_adap_cap", Arg::Opt, MaxClique::kbeam_cap, "adaptive k beam cap"),

    Arg("use_c_adap", Arg::Opt, MaxClique::useAdaptiveCPrune, "use c adaptive pruning"),
    Arg("c_downrate", Arg::Opt, MaxClique::cbeam_down_rate, "down rate for adaptive cbeam"),
    Arg("c_uprate", Arg::Opt, MaxClique::cbeam_up_rate, "up rate for adaptive cbeam"),
    Arg("c_adap_init", Arg::Opt, MaxClique::adaptiveCliqueBeamInitialValue, "init c beam for adaptive cbeam"),
